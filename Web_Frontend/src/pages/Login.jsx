...
export const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center p-4 h-screen bg-cover bg-center bg-no-repeat text-black"
         style={{
      ...
      <div className="md:w-1/3 border-2 border-[#6F4DF7] rounded-xl p-6 backdrop-blur-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-2 items-center mt-2 mb-2">
            ...
            <Link className="text-sm text-purple-600 hover:underline" to="/">
              Signup
            </Link>
          </div>

          <button
            className={`w-full py-2 text-white bg-purple-600 rounded-lg transition-all duration-200 ease-in-out ${
