...
export const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center p-4 bg-gradient-to-br from-purple-900 via-gray-900 to-black bg-cover bg-center bg-no-repeat text-black"
      style={{
